...
public class NodeScreen extends AbstractContainerScreen<NodeMenu> {
    ...
    public void addItemToFilterSlot(int slot, ItemStack item) {
        ...
        NetworkHandler.sendToServer(new AddNodeFilterItemPayload(
                node.getId(), selectedChannel, slot, ItemStackCompat.copyWithCount(item, 1)));
            ...
            for (int i = 0; i < ChannelData.FILTER_SIZE; i++) {
                if (isHoveringFilterButton(i, mx, my)) {
                    ...
                    if (btn == 1) {
                        ...
                        NetworkHandler.sendToServer(new SetChannelFilterItemPayload(
